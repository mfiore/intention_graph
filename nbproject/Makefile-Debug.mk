...
${OBJECTDIR}/BayesianNetwork.o: BayesianNetwork.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../pomdp -I../../devel/src/eigen -I../../devel/src/dlib-18.11 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BayesianNetwork.o BayesianNetwork.cpp

${OBJECTDIR}/IntentionGraph.o: IntentionGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../pomdp -I../../devel/src/eigen -I../../devel/src/dlib-18.11 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IntentionGraph.o IntentionGraph.cpp
